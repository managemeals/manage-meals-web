...
<nav
	class="bg-red-500 h-16 shadow flex justify-between items-center fixed top-0 w-full z-10 px-2"
...
{#if renderSidebar}
	...
	>
		<nav class="border-r-2 h-full flex flex-col items-center overflow-y-auto basis-16">
			<a href="/" class="hover:bg-gray-200 my-1 p-1 first:mt-3 last:mb-3 bg-white rounded">
				<CategoryIcon style="font-size: 2rem; color: #ef4444;" />
			</a>
			<a href="/" class="hover:bg-gray-200 my-1 p-1 first:mt-3 last:mb-3 bg-white rounded">
				<LabelIcon style="font-size: 2rem; color: #ef4444;" />
			</a>
			<a href="/settings" class="hover:bg-gray-200 my-1 p-1 first:mt-3 last:mb-3 bg-white rounded">
				<SettingsIcon style="font-size: 2rem; color: #ef4444;" />
			</a>
		</nav>
